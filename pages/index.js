...
const LeagueCard = ({_monitid = '',  _eventid = 0, _away = '', _home = '', _stakemode = {}, _betid = '0', _btodd = {away: 0, home: 0}, _psodd = {away: 0, home: 0}, count = 0}) => {
  ...
  console.log(Object.keys(betdata).length === 0 && betdata.constructor === Object)
            ...
            <div className="flex">
              <div>
                <div className="flex">
                  ...
                  <span className="w-40">{betdata.length == 0 || betdata == {} ? '-': betdata[0].gamedate}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`BetTime :`}</span>
                  <span className="w-40">{betdata.length == 0 || betdata == {} ? '-': betdata[0].betdate}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`BetPlace :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': betdata[0].place}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`Stake :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': betdata[0].stake}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`Odd :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': betdata[0].odds}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`Profit :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': betdata[0].odds * betdata[0].stake}</span>
                </div>
                <div className="flex">
                  <span className="w-20 text-end pr-3">{`Market :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': 'MoneyLine'}</span>
                </div>
                <div className="flex pt-1">
                  <span className="w-20 text-end pr-3">{`State :`}</span>
                  <span>{betdata.length == 0 || betdata == {} ? '-': betdata[0].state == 0 ? 'Pending' : betdata[0].state == 2 ? 'Win':'Lose'}</span>
                </div>
              </div>
              <div>
