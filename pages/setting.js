    ...
    <>
      <div className="h-screen">
        ...
        <div className="h-screen bg-gradient-to-r from-teal-400 to-green-600">
          <div className="pt-28 flex m-auto justify-center 	space-x-10 place-items-center">
            <div className=" m-3 border-solid bg-stone-800 p-2 rounded-lg">
              <div className="justify-center mb-2 w-full p-2">
                  <div className="flex justify-center w-full font-bold text-white text-2xl pl-8 py-2">
                    <h1>Sport Name</h1>
                  </div>
                  <div className="flex justify-center w-full font-bold text-white text-2xl pl-8 pt-2">
                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-3/5 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="0" placeholder="Please insert sport name.." onChange={(e) => setSportName(e.target.value)} required>          
                    </input>
                  </div>
              </div>
              <div className="flex">
                <div className="h-[580px] w-[300px] m-2 border-solid border-rose-600 bg-orange-600 p-2 rounded-lg">
                  <div className="mb-4 text-3xl font-bold flex justify-center w-full text-purple-900">
                    <h1>Betfair</h1>
                  </div>
                  <div className="relative mb-4">
                  <div className="relative mb-4">
                    <select className="cursor-pointer block w-full p-2 mb-6 overflow-auto text-lg text-center text-white border border-gray-300 rounded-lg bg-blue-600 focus:ring-blue-700 focus:border-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={(e) => {selectSportBt(e.target.value)}}>
                      {
                ...
                <div className="h-[580px] w-[300px] m-2 border-solid border-rose-600 bg-orange-600 p-2 rounded-lg">
                  ...
                  <div className="relative mb-4">
                    <select className="cursor-pointer block w-full p-2 mb-6 overflow-auto text-lg text-center text-white border border-gray-300 rounded-lg bg-blue-600 focus:ring-blue-800 focus:border-blue-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onChange={(e) => {selectSportPs(e.target.value)}}>
                        {
            ...
            <div>
              <button type="button" className="text-white bg-blue-700 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={addMornitor}>
                  Insert
